...
void DoImmune(int);
void DoInfect(int, float, int, int); //added int as argument to InfectSweep to record run number: ggilani - 15/10/14
void DoIncub(int, unsigned short int, int, int); //added int as argument to record run number: ggilani - 23/10/14
void DoDetectedCase(int, float, unsigned short int, int);
void DoCase(int, float, unsigned short int, int);
void DoFalseCase(int, float, unsigned short int, int);
